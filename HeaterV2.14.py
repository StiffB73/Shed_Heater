# Shed Temperature & Humidity Monitor v2.14 – FINAL with Heater Effectiveness Warning
# • Countdown only on manual activation
# • Auto runtime now shows days if >24h
# • Button text shows correct action
# • Warn if heater runs >1h with <2°C temperature increase
...
GRAPH_HOURS = 36
FUTURE_HOURS = 1
MIN_TEMP_RISE = 2          # Minimum °C increase expected after 1 hour
